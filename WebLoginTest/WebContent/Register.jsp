...
<body>
	<form method="post" action="RegisterServlet"
		onsubmit="return (check()&&checkfile())" enctype="multipart/form-data">
		<br>
		<div align="center" class="div1">
			Username: <input type="text" name="userName" id="checkn"><br>
			<br> Password: <input type="password" name="Pwd" id="checkp"><br>
			<br> Password again: <input type="password" name="Pwd2"
				id="checkp2"><br> <br> Image:<input type="file"
				name="file" id="checkimg"><br> <br> <input
...
<script type="text/javascript" language="JavaScript">
	...
	function checkfile() {
		...
		if (img_id != ".bmp" && img_id != ".png" && img_id != ".gif"
				&& img_id != ".jpg" && img_id != ".jpeg") {
			alert('not pic');
			return false;
		} else
			return true;
